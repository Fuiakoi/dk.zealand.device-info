...
namespace Tests.Playmode.Tests
{
    ...
    [UnityTest]
    public IEnumerator BenchmarkDeviceButtons()
    {
        ...
        // Wait one frame to ensure processing
        yield return null;
        ...
        // Log and assert
        Debug.Log($"Button actions executed in {duration * 1000} ms");
        Assert.LessOrEqual(duration, 0.5f, "Execution time exceeded 0.5 seconds");
    }
